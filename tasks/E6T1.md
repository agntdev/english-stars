...
Add /stats command for admin to view active users, sales count, and basic metrics. Write dialog spec to tests/specs/E6T1.json and append to tests/commands.json
