# E5T1 — Daily reminder scheduling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Schedule daily reminders at user-chosen time (default 09:00 local) using Redis job queue and Celery/Bull worker. Write dialog spec to tests/specs/E5T1.json
