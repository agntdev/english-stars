# E1T2 — Telegram Payments integration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Handle successful payment callbacks from Telegram, validate invoices, and process '10 stars' package purchases. Write dialog spec to tests/specs/E1T2.json and append to tests/commands.json
