# E1T3 — User access status update

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

On successful payment, mark user as 'unlocked' in PostgreSQL and credit their account. Write dialog spec to tests/specs/E1T3.json
