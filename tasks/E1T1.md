# E1T1 — /buy command with Buy button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Add /buy command to main menu with a 'Buy' button. When triggered, create Telegram invoice for '10 stars' package ($1.99 default). Write dialog spec to tests/specs/E1T1.json and append to tests/commands.json
