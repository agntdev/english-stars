# E2T2 — Reminder time configuration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Prompt user to set preferred daily reminder time (default 09:00 local). Store in PostgreSQL. Write dialog spec to tests/specs/E2T2.json and append to tests/commands.json
