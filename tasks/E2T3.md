# E2T3 — Locale configuration

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Prompt user to set language/locale preference (default English). Store in PostgreSQL. Write dialog spec to tests/specs/E2T3.json and append to tests/commands.json
