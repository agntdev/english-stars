# E3T3 — TTS audio generation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Implement TTS audio generation using Google Cloud TTS (with gTTS fallback) for word pronunciation. Store audio on cloud storage or generate on-demand with caching. Write dialog spec to tests/specs/E3T3.json
