# E2T1 — Initial deck delivery

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Deliver 20-word initial deck as 4 micro-lessons (5 words each) either immediately with spacing or on-demand. Write dialog spec to tests/specs/E2T1.json and append to tests/commands.json
