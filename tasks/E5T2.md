# E5T2 — /reminders command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Add /reminders command to configure reminder cadence (daily, every-other-day, off). Write dialog spec to tests/specs/E5T2.json and append to tests/commands.json
