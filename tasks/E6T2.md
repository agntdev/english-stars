# E6T2 — Error notifications

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ENSTAR

Send error notifications to TELEGRAM_ADMIN_CHAT_ID when payment fails or other critical errors occur. Write dialog spec to tests/specs/E6T2.json
